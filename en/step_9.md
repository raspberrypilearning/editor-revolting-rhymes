...
Rather than 'thing' - build a list of things!
...
You can comment out (or delete) the first two prints.

--- /task ---

--- task ---

Change the range in the for loop to print **up to four** lines of revolting rhyme!
